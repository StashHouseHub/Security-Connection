...
* Closes ports such as SMB 445, RPC 135, SNMP 161 and 162, TFTP 69, SOCKS 1080, and more (This is a security measure taken to reduce the possibility of an attack. Ability to use a printer may be affected due to the ports used for a printer have been used by hackers.)
